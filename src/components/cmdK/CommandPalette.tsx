...
function CommandPalette({
    ...
    function handleSelect() {
        ...
        if (item) {
            ...
            if (
                item.attributes.getNamedItem("data-close-on-select")?.value ===
                "true"
            ) {
                onChangeOpen(false);
            }
                    ...
                    <div className="command-palette-content antialiased">
                        ...
                        <div className="fixed inset-0 overflow-y-auto flex items-center justify-center">
                            <div className="flex w-full h-[450px] items-start justify-center p-4">
                                ...
                                >
                                    <Dialog.Panel className="w-full max-h-full bg-neutral-800 shadow-lg rounded-lg max-w-xl flex flex-col overflow-hidden divide-y dark:divide-neutral-800">
